...
public class Dijkstra extends AlgoritmoDeBusqueda {
	...
	private PriorityQueue< Node > Q; //priority queue propia de Java, usamos el comparador definido para que el de menor valor este en el tope
	...
	public Dijkstra(Integer max,Integer inf,Mapa mapa ){
		this.max = max;
		this.inf = inf;
		...
		this.Q = new PriorityQueue<Node>(); //priority queue propia de Java, usamos el comparador definido para que el de menor valor este en el tope
