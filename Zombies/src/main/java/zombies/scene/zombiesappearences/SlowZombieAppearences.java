...
public class SlowZombieAppearences {
	...
	public static final SlowZombieAppearences INSTANCE = new SlowZombieAppearences();
	
	public SlowZombieAppearences(){
	
		SpriteMoved[] sprites4 = {(SpriteMoved) SpriteMoved.fromImage("slow zombie callendo despacio 1.png"),
			SpriteMoved.fromImage("slow zombie callendo despacio 2.png"),
			SpriteMoved.fromImage("slow zombie callendo despacio 3.png"),
			SpriteMoved.fromImage("slow zombie callendo despacio 4.png"),
			SpriteMoved.fromImage("slow zombie callendo despacio 5.png"),
			SpriteMoved.fromImage("slow zombie callendo despacio 6.png"),
			SpriteMoved.fromImage("slow zombie callendo despacio 7.png"),
			SpriteMoved.fromImage("slow zombie callendo despacio 8.png"),
			SpriteMoved.fromImage("slow zombie callendo despacio 9.png"),
			SpriteMoved.fromImage("slow zombie callendo despacio 10.png"),
			SpriteMoved.fromImage("slow zombie callendo despacio 11.png"),
			SpriteMoved.fromImage("slow zombie callendo despacio 12.png")};
		this.callendoDespacioAnimation =  new AnimationRotateMovedLowCost(.05,sprites4);
		
		
		SpriteMoved[] sprites5 = {SpriteMoved.fromImage("slow zombie muerto despacio 1.png"),
				SpriteMoved.fromImage("slow zombie muerto despacio 1.png"),
				SpriteMoved.fromImage("slow zombie muerto despacio 1.png"),
				SpriteMoved.fromImage("slow zombie muerto despacio 1.png"),
				SpriteMoved.fromImage("slow zombie muerto despacio 1.png"),
				SpriteMoved.fromImage("slow zombie muerto despacio 1.png"),
				SpriteMoved.fromImage("slow zombie muerto despacio 2.png"),
				SpriteMoved.fromImage("slow zombie muerto despacio 5.png"),
				SpriteMoved.fromImage("slow zombie muerto despacio 3.png"),
				SpriteMoved.fromImage("slow zombie muerto despacio 4.png")};
		this.enElPisoAnimationDespacio = new AnimationRotateMovedLowCost(.1,sprites5);
		
		SpriteMoved[] sprites6 = {SpriteMoved.fromImage("slow zombie muerto violento.png")};
		this.quedarseTiradoEnElPisoAnimation = new AnimationRotateMovedLowCost(.5,sprites6);
		
		SpriteMoved[] sprites1 = {SpriteMoved.fromImage("slow zombie caminando.png"),
				SpriteMoved.fromImage("slow zombie caminando1.png"),
				SpriteMoved.fromImage("slow zombie caminando2.png"),
				SpriteMoved.fromImage("slow zombie caminando1.png"),
				SpriteMoved.fromImage("slow zombie caminando.png"),
				SpriteMoved.fromImage("slow zombie caminando3.png"),
				SpriteMoved.fromImage("slow zombie caminando4.png"),
				SpriteMoved.fromImage("slow zombie caminando3.png")};
		this.imagenCaminando =  new AnimationRotateMovedLowCost(.4, sprites1);
		
		SpriteMoved[] sprites2 = {SpriteMoved.fromImage("slowZombieGolpeando1.png"),
				SpriteMoved.fromImage("slowZombieGolpeando2.png"),
				SpriteMoved.fromImage("slowZombieGolpeando3.png"),
				SpriteMoved.fromImage("slowZombieGolpeando4.png")};
		this.imagenGolpeando =  new AnimationRotateMovedLowCost(.4, sprites2);
		
		SpriteMoved[] sprites3 = {SpriteMoved.fromImage("slowZombieGolpeandoPersonaje5.png"),
				SpriteMoved.fromImage("slowZombieGolpeandoPersonaje4.png"),
				SpriteMoved.fromImage("slowZombieGolpeandoPersonaje3.png"),
				SpriteMoved.fromImage("slowZombieGolpeandoPersonaje2.png"),
				SpriteMoved.fromImage("slowZombieGolpeandoPersonaje1.png"),
				SpriteMoved.fromImage("slowZombieGolpeandoPersonaje2.png")};
		this.imagenGolpeandoPersonaje =  new AnimationRotateMovedLowCost(.4, sprites3);
		
		
		SpriteMoved[] sprites7 = {SpriteMoved.fromImage("slow zombie impactado1.png"),
				SpriteMoved.fromImage("slow zombie impactado2.png"),
				SpriteMoved.fromImage("slow zombie impactado3.png")};
	...
	public static SlowZombieAppearences getInstance() {
		return INSTANCE;
	}
