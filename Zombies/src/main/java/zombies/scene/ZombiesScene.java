...
public class ZombiesScene extends GameScene {
...
//		return this.getMonstruos().size() <= 0 && this.oleadas.size() <= 0 && this.currentOleada().getMonstruos().size() <= 0;
		return false;
	}
...
//		this.addOleadasHard();
	...
	public void cargarPersonaje() {
		...
		AnimationRotateMoved personajeParado = new AnimationRotateMoved(.01,sprites2);
		 Personaje personaje = new Personaje(personajeParado,personajeX,personajeY, 0, dimension.getWidth(), 0  , dimension.getHeight(),
...
//		System.out.println("balasrestantes");
//		System.out.println(this.balasRestantes);
//		System.out.println("balas");
//		System.out.println(this.balas);
